...
module.exports = function(sequelize, DataTypes) {
  var activitystatus = sequelize.define('activitystatus', {
    ...
    sequelize, tableName: 'activitystatus', timestamps: false, indexes: [{name: "PRIMARY",unique: true,using: "BTREE",fields: [{ name: "id" }]}]
  });
