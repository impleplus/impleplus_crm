...
module.exports = function(sequelize, DataTypes) {
  var tax_item = sequelize.define('tax_item', {
		id: { type: DataTypes.STRING(36), allowNull: false, primaryKey: true },
		tax_id: {type: DataTypes.STRING(36), allowNull: true },
    ...
    sequelize, tableName: 'tax_item', timestamps: false, indexes: [{name: "PRIMARY",unique: true,using: "BTREE",fields: [{ name: "id" }]}]
  });
  return tax_item;
};