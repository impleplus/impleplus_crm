...
module.exports = function(sequelize, DataTypes) {
  var customer = sequelize.define('customer', {
		...
		customer_type: {type: DataTypes.SMALLINT,allowNull: true},
		...
		bankaccount: {type: DataTypes.STRING(100), allowNull: true },
    ...
    sequelize, tableName: 'customer', timestamps: false, indexes: [{name: "PRIMARY",unique: true,using: "BTREE",fields: [{ name: "id" }]}]
  });
  return customer;
};