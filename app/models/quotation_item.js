...
module.exports = function(sequelize, DataTypes) {
  var quotation_item = sequelize.define('quotation_item', {
		id: { type: DataTypes.STRING(36), allowNull: false, primaryKey: true },
		quotation_id: {type: DataTypes.STRING(36), allowNull: true },
    ...
    sequelize, tableName: 'quotation_item', timestamps: false, indexes: [{name: "PRIMARY",unique: true,using: "BTREE",fields: [{ name: "id" }]}]
  });
