...
module.exports = function(sequelize, DataTypes) {
  var product = sequelize.define('product', {
		...
		productgroup_id: {type: DataTypes.STRING(36), allowNull: true },
		code: {type: DataTypes.STRING(50), allowNull: true },
		name: {type: DataTypes.STRING(100), allowNull: true },
		vendor: {type: DataTypes.STRING(100), allowNull: true },
		price_manufactory: {type: DataTypes.INTEGER,allowNull: true},
		price_sale: {type: DataTypes.INTEGER,allowNull: true},
    ...
    sequelize, tableName: 'product', timestamps: false, indexes: [{name: "PRIMARY",unique: true,using: "BTREE",fields: [{ name: "id" }]}]
  });
  return product;
};