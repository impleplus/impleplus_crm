...
module.exports = function(sequelize, DataTypes) {
  var receipt_item = sequelize.define('receipt_item', {
		id: { type: DataTypes.STRING(36), allowNull: false, primaryKey: true },
		receipt_id: {type: DataTypes.STRING(36), allowNull: true },
    ...
    sequelize, tableName: 'receipt_item', timestamps: false, indexes: [{name: "PRIMARY",unique: true,using: "BTREE",fields: [{ name: "id" }]}]
  });
  return receipt_item;
};