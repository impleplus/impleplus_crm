...
module.exports = function(sequelize, DataTypes) {
  var invoice_item = sequelize.define('invoice_item', {
    ...
    sequelize, tableName: 'invoice_item', timestamps: false, indexes: [{name: "PRIMARY",unique: true,using: "BTREE",fields: [{ name: "id" }]}]
  });
  return invoice_item;
};